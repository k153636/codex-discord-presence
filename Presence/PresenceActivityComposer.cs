...
internal static class PresenceActivityComposer
{
        ...
        string stateLabel)
    {
        return context.Codex.ActivityKind switch
        {
            ...
            CodexActivityKind.ReviewingDiff => stateLabel,
            CodexActivityKind.SearchingContext => stateLabel,
            CodexActivityKind.Building => stateLabel,
            CodexActivityKind.Testing => stateLabel,
            CodexActivityKind.Debugging => stateLabel,
